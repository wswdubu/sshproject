...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dwzSearch(this, 'dialog');" action="user_listlook.do" method="post">
	<div class="searchBar">
	...
	<table class="table" width="98%" targetType="dialog" asc="asc" desc="desc">
		...
		<s:iterator id="pojo" value="userlist">
			<tr target="sid_entity" rel="${pojo.id}">
				...
				<td>
			<a class="btnSelect" href="javascript:$.bringBack({id:'${pojo.id }',realname:'${pojo.realname}'})" multLookup="empItems" title="查找带回">选择</a>
				</td>
			</tr>
		 </s:iterator>
		</tbody>
