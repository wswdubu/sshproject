...
<div class="pageContent">
	<form method="post" action="privilege_update.do" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label><tsp:transproname proname="privilege.priurl"/>：</label>
				<input name="privilege.priurl" type="text" maxlength="150" value="${privilege.priurl }"/>
			</p>
			<p>
				<label><tsp:transproname proname="privilege.priname"/>：</label>
				<input name="privilege.priname" type="text" maxlength="150" value="${privilege.priname }"/>
			</p>
			<p>
				<label><tsp:transproname proname="privilege.type"/>：</label>
				<tsp:select name="privilege.type" value="${privilege.type}"/>
			</p>
